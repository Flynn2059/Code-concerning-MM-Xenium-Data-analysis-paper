...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  6 10:11:43 2026
...
sc.pp.neighbors(adata_T_NK,n_pcs=7,use_rep="X_pca_harmony")
...
sc.tl.leiden(adata_T_NK,resolution=0.3,flavor="igraph",n_iterations=-1)
...
celltype.loc[celltype['ClusterID'].isin(['0']), 'celltype'] = 'CD8+ T'
celltype.loc[celltype['ClusterID'].isin(['1']), 'celltype'] = 'CD8+ T'
celltype.loc[celltype['ClusterID'].isin(['2']), 'celltype'] = 'SOX2-OT Unknown'
celltype.loc[celltype['ClusterID'].isin(['3']), 'celltype'] = 'CD4+ T'
celltype.loc[celltype['ClusterID'].isin(['4']), 'celltype'] = 'Myeloid'
celltype.loc[celltype['ClusterID'].isin(['5']), 'celltype'] = 'Myeloid'
celltype.loc[celltype['ClusterID'].isin(['6']), 'celltype'] = 'CD8+ T'
...
annotation.to_csv("4_control_T_secondary_annotation.csv")