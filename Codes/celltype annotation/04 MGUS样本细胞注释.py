...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  6 13:42:06 2026
...
annotation.to_csv("2_mgus_major_annotation.csv")
print(adata.obs['celltype'].value_counts())
...
sc.pp.neighbors(adata_T_NK,n_pcs=15,use_rep="X_pca_harmony")
...
sc.tl.leiden(adata_T_NK,resolution=0.8,flavor="igraph",n_iterations=-1)
...
celltype.loc[celltype['ClusterID'].isin(['0']), 'celltype'] = 'CD8+ T Effector'
celltype.loc[celltype['ClusterID'].isin(['1','7']), 'celltype'] = 'T Proliferating'
celltype.loc[celltype['ClusterID'].isin(['2','5']), 'celltype'] = 'CD4+ T Central Memory'
celltype.loc[celltype['ClusterID'].isin(['3','6']), 'celltype'] = 'CD8+ T Exhausted'
celltype.loc[celltype['ClusterID'].isin(['4','8']), 'celltype'] = 'Myeloid'
celltype.loc[celltype['ClusterID'].isin(['9']), 'celltype'] = 'SOX2-OT Unknown'
...
annotation.to_csv("2_mgus_T_secondary_annotation.csv")