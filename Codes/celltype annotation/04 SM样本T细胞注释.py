...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  6 13:19:03 2026
...
annotation.to_csv("5_sm_major_annotation.csv")
print(adata.obs['celltype'].value_counts())
...
sc.pp.neighbors(adata_T_NK,n_pcs=10,use_rep="X_pca_harmony")
...
celltype.loc[celltype['ClusterID'].isin(['0']), 'celltype'] = 'T Proliferating'
celltype.loc[celltype['ClusterID'].isin(['1']), 'celltype'] = 'CD8+ T Effector'
celltype.loc[celltype['ClusterID'].isin(['2']), 'celltype'] = 'CD4+ T Naive'
celltype.loc[celltype['ClusterID'].isin(['3']), 'celltype'] = 'SOX2-OT Unknown'
celltype.loc[celltype['ClusterID'].isin(['4','5']), 'celltype'] = 'Myeloid'
...
annotation.to_csv("5_sm_T_secondary_annotation.csv")
