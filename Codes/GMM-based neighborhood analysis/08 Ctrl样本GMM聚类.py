...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 12:57:52 2026
...
all_cell_niche_df.to_csv(
    os.path.join(outdir, "Ctrl_4_samples_cell_niche_matrix.csv"),
    index=False
)

print("All samples finished.")
print("Cell-level niche matrix saved:")
print(os.path.join(outdir, "Ctrl_4_samples_cell_niche_matrix.csv"))